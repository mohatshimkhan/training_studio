		...
		<div class="container-fluid my-2">
			<div class="row mb-2">
				...
				<div class="col-sm-6 text-right">
					<a href="{{ route('trainers.create') }}" class="btn btn-primary">New Trainer</a>
				</div>
			</div>
		</div>
		<!-- /.container-fluid -->
				...
				<form name="searchForm" id="searchForm" method="get" action="">
					<div class="card-header">
						<div class="card-title">
							<button type="button" class="btn btn-default btn-sm" onclick="window.location.href='{{ route("trainers.index") }}'">Reset</button>
						</div>
							...
							@foreach($trainers as $trainer)
								<tr>
									...
									<td>
										...
										<a href="javascript:void(0)"  onclick="deleteRow({{ $trainer->id }})" class="text-danger w-4 h-4 mr-1">
