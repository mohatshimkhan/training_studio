								...
								<div class="card-body">
									<div class="col-md-12">
										<div class="mb-3">
											...
											<input type="text" name="header_logo_title" id="header_logo_title" class="form-control" placeholder="Enter..."><p></p>	
										</div>
									</div>	
								...
								<div class="card-body">
									...
									<div class="col-md-12">
										<div class="mb-3">
											...
											<input type="text" name="mba_heading_tag" id="mba_heading_tag" class="form-control" placeholder="Enter..."><p></p>	
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3">
											<label for="mba_heading_title">Heading Title</label>
											<input type="text" name="mba_heading_title" id="mba_heading_title" class="form-control" placeholder="Enter..."><p></p>	
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3">
											<label for="mba_bg_video">Banner BG Video</label>
											<input type="text" name="mba_bg_video" id="mba_bg_video" class="form-control" placeholder="Enter..."><p></p>	
										</div>
									</div>
								...
								<div class="card-body">
									...
									<div class="col-md-12">
										<div class="mb-3">
											...
											<input type="text" name="cta_title" id="cta_title" class="form-control" placeholder="Enter..."><p></p>	
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="mb-3">
											...
											<textarea name="cta_description" id="cta_description" class="form-control" placeholder="Enter..."></textarea><p></p>	
										</div>
									</div>	
								...
								<div class="card-body">
									...
									<div class="col-md-12">
										<div class="mb-3">
											...
											<textarea name="footer_text" id="footer_text" class="form-control" placeholder="Enter..."></textarea><p></p>
										</div>
									</div>	
