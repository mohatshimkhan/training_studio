...
<html lang="en">
    <head>
        ...
        <!-- summernote -->
        <link rel="stylesheet" href="<?php echo e(asset('backend/assets/plugins/summernote/summernote-bs4.css')); ?>">
    ...
    <body class="hold-transition sidebar-mini">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
                            <img src="<?php echo e(asset('backend/assets/img/avatar5.png')); ?>" class='img-circle elevation-2' width="40" height="40" alt="">
                        </a>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
                            <h4 class="h4 mb-0"><strong> Test
                                 </strong></h4>
                            <div class="mb-3">testatgmail.com</div>
                            ...
                            <a href="<?php echo e(route('admin.logout')); ?>" class="dropdown-item text-danger" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();">
                                <i class="fas fa-sign-out-alt mr-2"></i> <?php echo e(__('Logout')); ?>

                                
                                <form id="logout-form" action="<?php echo e(route('admin.logout')); ?>" method="GET" class="d-none">
                                    <?php echo csrf_field(); ?>
                                </form>
                            </a>
        ...
        <!-- Summernote -->
        <script src="<?php echo e(asset('backend/assets/plugins/summernote/summernote-bs4.min.js')); ?>"></script>
        <script>
          $(function () {
            // Summernote
            $('.textarea').summernote()
...
</html><?php /**PATH E:\wamp\www\mp\LARAV\training_studio\resources\views/backend/layouts/app.blade.php ENDPATH**/ ?>